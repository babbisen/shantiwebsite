        ...
        <div className="bg-slate-800/70 backdrop-blur-sm rounded-2xl border border-slate-700/50 shadow-2xl overflow-hidden mb-8">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <div className="space-y-2"><label htmlFor="pricePaid" className={labelStyle}>Price Paid</label><input id="pricePaid" name="pricePaid" type="number" value={form.pricePaid} onChange={handleChange} min={0} className={inputStyle} /></div>
            </div>
